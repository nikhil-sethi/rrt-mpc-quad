...
if __name__ == "__main__":
    ...
    parser.add_argument('--planner', default="rrt_star", type=str,
                        help='Planner options (rrt, inf_rrt, rec_rrt, rrt_star, inf_rrt_star) (default: "rrt_star")',
                        metavar='')
    parser.add_argument('--min_snap', default=True, type=str2bool, help='Min Snap (default: False)',
                        metavar=''),
    parser.add_argument('--seed', default=None, type=int, help='Seed (default: None)', metavar=''),
    parser.add_argument('--plot_all', default=True, type=str2bool,
                        help='Will plot all nodes and connections (default: False)', metavar='')
